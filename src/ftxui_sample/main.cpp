...
// configuration step. It creates a namespace called `legged_control_cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", legged_control_cpp::cmake::project_name, legged_control_cpp::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", legged_control_cpp::cmake::project_version);
      return EXIT_SUCCESS;
    }
